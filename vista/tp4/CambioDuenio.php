...
<form method="post" action="../accion/tp4/accionCambioDuenio.php" id="cambioDuenio" class="needs-validation" novalidate>
	<div class="container">
        <div class="col">
            ...
            <input id="Patente" class="form-control" name ="Patente" type="text" value="<?php echo $patente;?>" pattern="^[A-Za-zÁÉÍÓÚáéíóúÑñ0-9]+([ \-]?[A-Za-zÁÉÍÓÚáéíóúÑñ0-9]+)*$" minlength="4" maxlength="9" placeholder="AA 123 ZZ" required/>
        ...
        <div class="col">
            ...
            <input type="number" class="form-control" id="NroDni" name="NroDni" min="10000000" max="99999999" placeholder="00000000" required/>
